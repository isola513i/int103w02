...
import Java.company.Employee;
import Java.company.Staff;
...
//        testStaff();
  ...
  static void testCollection() {
    ...
    c.add(new Employee(1, "Second", 10000.00));
    c.add(new Staff(2, "Third", 15000.00, 30));
    System.out.println(c);
    for (int i = 0; i < c.getCount(); i++) {
      Object o = c.get(i);
//      if (o.getClass().equals(Employee.class)) {
        if(o instanceof Employee) {
        System.out.println("Id: " + ((Employee) o).getId());
      }
    }
  }
}